...
import bridgeVersionModel from "../mongoModel/bridge_version.js";
import configurationModel from "../mongoModel/configuration.js";
import apiCallModel from "../mongoModel/apiCall.js";
import apikeyCredentialsModel from "../mongoModel/apiModel.js"; // Check if this is correct model for apikeycredentials
import testcasesHistoryModel from "../mongoModel/testcaseModel.js"; // Check if this is correct
import conversationDbService from "./conversationDbService.js";
...
async function updateBridges(bridge_id, data, version_id = null) {
    try {
        ...
        if (version_id) {
            result = await bridgeVersionModel.findOneAndUpdate(
                { _id: version_id },
                updateQuery,
                { new: true }
            );
