...
async function findRecentOrchestratorThreads(org_id, agent_id, filters, page = 1, limit = 30) {
  try {
    ...
    const whereConditions = {
      org_id: org_id,
      [Sequelize.Op.and]: [Sequelize.literal(`bridge_id ? '${agent_id}'`)],
    };
...
export { findOrchestratorConversationLogsByIds, findRecentOrchestratorThreads, findOrchestratorThreadHistoryFormatted };
