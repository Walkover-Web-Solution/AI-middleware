...
const getAllBridges = async (org_id) => {
    try {
        const bridges = await configurationModel.find({ org_id: org_id }, { bridge_id: 1, _id: 1, name: 1, service: 1, org_id: 1, "configuration.model": 1, "configuration.prompt": 1, "configuration.input": 1 });
