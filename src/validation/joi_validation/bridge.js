...
const updateBridgeSchema = Joi.object({
  ...
  configuration: Joi.object({
    model: Joi.string().when('service', {
      is: 'google',
      then: Joi.valid("gemini_pro","gemini-1.5-pro","gemini-1.0-pro-vision","gemini-1.0-pro","gemini-1.5-Flash"),
  ...
  org_id: Joi.number().required().messages({
    'number.base': 'The input must be a number'
  })
}).when(Joi.object({
  'configuration.model': Joi.string().valid('gpt-3.5-turbo', 'gpt-3.5-turbo-0613', 'gpt-3.5-turbo-0125', 'gpt-3.5-turbo-0301', 'gpt-3.5-turbo-1106', 'gpt-3.5-turbo-16k', 'gpt-3.5-turbo-16k-0613', 'gpt-4', 'gpt-4-0613', 'gpt-4-1106-preview', 'gpt-4-turbo-preview', 'gpt-4-0125-preview', 'gpt-4-turbo-2024-04-09', 'gpt-4-turbo', 'gpt-4o', 'text-embedding-3-large', 'text-embedding-3-small', 'text-embedding-ada-002', 'gpt-3.5-turbo-instruct', 'gemini_pro','gemini-1.5-pro','gemini-1.0-pro-vision','gemini-1.0-pro','gemini-1.5-Flash')
}).unknown(), {
  then: Joi.object({
    configuration: Joi.object({
