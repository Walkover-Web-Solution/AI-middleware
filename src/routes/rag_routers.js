...
import { GetAllDocuments, create_vectors, get_vectors_and_text, get_all_docs, delete_doc  } from "../controllers/RagController.js";
...
routes.get('/docs', middleware, get_all_docs);
