...
} from "../middlewares/interfaceMiddlewares.js";
...
router.post(
  "/loginuser",
  combinedAuthWithChatBotTokenDecodeAndPublicChatbot,
  validate(chatBotValidation.loginUser),
  loginUser
);
...
router.put(
  ...
  middleware,
  userOrgAccessCheck,
  validate(chatBotValidation.addOrRemoveBridgeInChatBot),
  addorRemoveBridgeInChatBot
);
...
router.post(
  ...
  middleware,
  validate(chatBotValidation.createOrRemoveAction),
  createOrRemoveAction
);
