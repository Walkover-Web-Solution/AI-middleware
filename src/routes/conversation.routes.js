...
router.get('/history/sub-thread/:thread_id', middleware, validate(conversationValidation.getAllSubThreadsController), common.getAllSubThreadsController); //used by someone else
