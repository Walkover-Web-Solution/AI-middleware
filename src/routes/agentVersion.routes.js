...
//create Version
router.post("/", middleware, validate(bridgeVersionValidation.createVersion), agentVersionController.createVersion);

//bulk publish
router.post("/bulk_publish", middleware, validate(bridgeVersionValidation.bulkPublishVersion), agentVersionController.bulkPublishVersion);

//get Version
router.get("/:version_id", middleware, validate(bridgeVersionValidation.getVersion), agentVersionController.getVersion);

//publish Version
router.post("/publish/:version_id", middleware, validate(bridgeVersionValidation.publishVersion), agentVersionController.publishVersion);

//delete Version
router.delete("/:version_id", middleware, validate(bridgeVersionValidation.removeVersion), agentVersionController.removeVersion);

//discard Version
router.post("/discard/:version_id", middleware, validate(bridgeVersionValidation.discardVersion), agentVersionController.discardVersion);
...
router.get("/connected-agents/:version_id", middleware, validate(bridgeVersionValidation.getConnectedAgents), agentVersionController.getConnectedAgents);
