...
async function getAllSubThreadController(req, res, next) {
    ...
    const data = req?.chatBot?.ispublic ? await configurationService.getAgentByUrlSlugname(slugName) : await configurationService.getAgentIdBySlugname(org_id, slugName);
