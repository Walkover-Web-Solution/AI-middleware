...
router.get('/gethistory-chatbot/:thread_id/:bridge_slugName', chatBotAuth, common.getThreads,statusMiddleware);//Route Depricated //Public API for getting history for particular thread
