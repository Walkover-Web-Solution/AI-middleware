...
router.get('/gethistory-chatbot/:thread_id/:bridge_slugName', chatBotAuth, common.getThreads,statusMiddleware); //Public API for getting history for particular thread
...
router.get('/getallsystemprompts/:bridge_id', middleware, common.getAllSystemPromptHistory,statusMiddleware);
