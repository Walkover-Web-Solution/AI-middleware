...
const getThreadHistory = async ({ thread_id, org_id, bridge_id, page, pageSize,user_feedback }) => {
  try {
    const chats = await chatbotDbService.findMessage(org_id, thread_id, bridge_id, page, pageSize,user_feedback);
    return {
      success: true,
      data: chats
    };
